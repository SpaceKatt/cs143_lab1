...
public class EditCity extends javax.swing.JDialog {
     ...
     */
    EditCity(CitiesGUI aThis, boolean modal, City oldCity) {
        super(aThis, modal);
        initComponents();
        ...
        this.setModal(true);
        nameJTextField.setText(this.oldCity.getName());
        this.medianJTextField.setText(this.oldCity.getMedian()+"");
        this.degreeJTextField.setText(this.oldCity.getDegree()+"");
        percentJTextField.setText(""+this.oldCity.getLocal());
        popJTextField.setText(this.oldCity.getPopulation()+"");
